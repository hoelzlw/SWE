...
class SWE_Scenario {
 ...
 public:
    ...
    virtual float getWaterHeight(float, float) { return 10.0f; };
    virtual float getVeloc_u(float, float) { return 0.0f; };
    virtual float getVeloc_v(float, float) { return 0.0f; };
    virtual float getBathymetry(float, float) { return 0.0f; };

    virtual float waterHeightAtRest() { return 10.0f; };

    virtual float endSimulation() { return 0.1f; };

    virtual BoundaryType getBoundaryType(BoundaryEdge) { return WALL; };
